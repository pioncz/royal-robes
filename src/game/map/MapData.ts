...
// Columns
MapData = [...MapData, ...generateColumn(4, 2, 'c3', 0.5)];
MapData = [...MapData, ...generateColumn(9, 2, 'c3', 0.5)];
MapData = [...MapData, ...generateColumn(14, 2, 'c3', 0.5)];
MapData = [...MapData, ...generateColumn(19, 2, 'c3', 0.5)];
