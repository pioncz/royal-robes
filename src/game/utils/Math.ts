...
export const pointInDirection = (point: Point, direction: number, radius: number) => {
...
export const getObjectsInRadius = (originPosition: Point, objects: { $: THREE.Object3D}[], radius: number) =>
  objects.filter(
    (o) =>
